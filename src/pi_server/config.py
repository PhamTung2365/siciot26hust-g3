...
# ==================== TCP SOCKET CAMERA ====================
TCP_CAMERA_ENABLED = True
TCP_CAMERA_HOST = '0.0.0.0'
TCP_CAMERA_PORT = 5001  # Port for ESP32-CAM TCP socket streaming
TCP_FRAME_MAX_BYTES = 524288  # 512 KiB max frame size
TCP_CAMERA_TIMEOUT = 10  # Seconds before socket timeout
